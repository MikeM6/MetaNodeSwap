...
contract Pool is IPool {
    ...
    function swap(
        ...
        // 判断当前价格是否满足交易的条件
        require(
            zeroForOne // 要存token0，换token1
                ? // sqrtPriceLimitX96: token0最低接收的价格是多少
                // sqrtPriceX96: 当前价格是多少
        ...
        // 存入状态
        // amountSpecified： 当前要换的币数
        // amountCalculated： 已经计算的数量
        // feeGrowthGlobalX128： 全局手续费
